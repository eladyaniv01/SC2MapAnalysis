...
.. code-block::
        ...
        >>> map_data.debugger.scatter(x,y,color="green",marker=r"$\heartsuit$", s=500, edgecolors="r")
        >>> map_data.show()
...
.. code-block::
        ...
        >>> # also,  lets change the heart suit to a simple start marker and remove the edge color
